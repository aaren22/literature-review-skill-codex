...
## 想要完整版?——科研写作 SOP(33 skill)

本免费版只是完整 SOP 里的**文献综述**部分(5 个 skill)。完整版还有另外 28 个 skill,覆盖从选题到投稿全流程:

| 层 | 包含的 skill |
|------|-------|
| 1-选题层 | 选题发掘 / 选题验证 / 研究问题精炼 / 论文类型诊断 |
| 2-文献层 | ✅ 文献检索 / 文献获取 / 文献精读 / 文献综述写作 / 文献综述章节(本免费版) |
| 3-设计层 | 方法选择 / 理论框架 / 研究伦理 |
| 4-规划层 | 数据规划 / 数据收集 / 数据分析 |
| 5-写作层 | 结构规划 / 引言 / 方法章 / 结果章 / 讨论章 / 结论章 / 摘要 / 论证构建 |
| 6-修改层 | 自审清单 / 模拟评审 / 润色 / 查重应对 |
| 7-投稿层 | 期刊竞赛匹配 / 投稿信推荐信 / 回复审稿意见 |
| 8-跨语言层 | 中英翻译 / 学术中文 |
| 9-格式层 | 引用管理 / 学术排版与格式 |
| ➕ 导航 | 论文写作导航(33 skill 主索引) |

每个 skill 都基于经典方法论,带 `assets/`(填空模板)+ `references/`(详解),不是 AI 凭感觉写的内容。

### 💰 价格 ¥99

一次买断,所有更新免费。本科 / 硕士 / 博士 / 科研工作者通用,中英双轨设计。

### 🛒 怎么买

- 产品页: <https://zhanlinyan.com/products>
- 微信咨询/购买: **13258220726**(加微信注明"科研 skill")
...
完整 33 skill 版本 ¥99(产品页 <https://zhanlinyan.com/products> / 微信 **13258220726**)。免费的这 5 个子 skill 是完全自包含的——能独立完成"从找文献到写完综述"全程,不依赖完整 SOP。
...
- **完整科研写作 SOP(33 skill / 9 层)** ¥99 → 产品页 <https://zhanlinyan.com/products> · 微信 **13258220726**
- **本免费版 bug / 改进建议** → GitHub Issues 或 PR
